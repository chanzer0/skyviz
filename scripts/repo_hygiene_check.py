...
CORE_REQUIRED_PATHS = [
    ...
    'scripts/compare_completionist_sources.py',
    'scripts/refresh_completionist_snapshot.py',
    'scripts/export_skycards_user.py',
    'scripts/serve_local_preview.py',
    'scripts/check_cloudflare_account.py',
    '.env.skycards.local.example',
    '.github/workflows/ci.yml',
    '.github/workflows/deploy-pages.yml',
    'docs/decisions/2026-03-23-cloudflare-completionist-data-plane.md',
    'docs/decisions/2026-03-23-fr24-shared-completionist-consumer.md',
    'docs/plans/active/2026-03-23-fr24-shared-completionist-cutover.md',
