...
8. Use the data-tools icon next to the `Map`/`Aircraft` toggle to manage the active dashboard: upload a new export, turn browser-local save on or off for the current upload, or clear current and saved local data.
